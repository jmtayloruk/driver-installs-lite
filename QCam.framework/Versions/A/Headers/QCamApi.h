 ...
 */
	...
	(
		...
		QCam_SettingsEx*	pSettings			// IN: pointer to an unallocated, unitialized opaque settings struct
												// OUT: allocated and initialized settings structure
	);
