### AVT PvAPI GigE SDK 1.28 for Mac OS X
###
### 01/12/15
###
...
* The MTU of the GigE adapter MUST be changed to Jumbo frames (9000). See System Preferences -> Network -> Ethernet -> Advanced ->Ethernet -> MTU, or use command line "ifconfig". If a lower MTU is used, camera connection will drop when a camera streams or control network traffic floods to NIC.
...
* Mac OS X' implementation of Link Aggregation is not supported by PvAPI
...
* This distribution support x86,x64 for OS X 10.5 to 10.8. Modify the "ARCH" file located in the Examples directory before building the samples to select the proper architecture: x86 or x64.
